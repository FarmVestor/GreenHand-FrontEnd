...
export default function EditFarm() {
  ...
  const [farmData, setFarmData] = useState({ userId: 0, farmName: '', cityId: 0, farmArea: 0, cropId: 0, farmLicense: '', farmAvailable: 1, farmKindId: 0, farmVisibiltiy: 1, farmWaterSalinity: 0, farmLastCropsId: 0, farmFertilizer: '', farmTreesAge: 0, farmDescription: '',farmLongitude:40.5,farmLatitude:28.5 })
                ...
                <MKBox component="form" role="form">
                  ...
                  <MKBox mb={2}>
                    <FormControl>
                      ...
                      <RadioGroup value={farmData?.farmVisibiltiy} row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group" onChange={(e) => { updateFarmData({  farmVisibiltiy: e.target.value }) }} >
